...
export const badges: BadgeDefinition[] = [
  ...
  },
  {
    id: 'zins-meister',
    name: 'Zins-Meister',
    description: 'Zinsrechnung und Buchungen gemeistert',
    hint: 'Schließe die Lektionen Zinsrechnung und Zinserträge buchen ab',
    icon: '🧮',
    condition: { type: 'specific-lessons', value: 2, lessonIds: ['zinsrechnung', 'zinsertraege-buchen'] },
    xpBonus: 15,
  },
  {
    id: 'boersen-kenner',
    name: 'Börsen-Kenner',
    description: 'Börse, Indizes und weltweite Märkte gelernt',
    hint: 'Schließe die Lektionen Börse & Xetra, Aktienindizes und Weltweite Indizes ab',
    icon: '🏛️',
    condition: { type: 'specific-lessons', value: 3, lessonIds: ['boerse-xetra', 'aktienindizes', 'weltweite-indizes'] },
    xpBonus: 20,
  },
  {
    id: 'komplett-geloescht',
    name: 'Komplett Gelöscht!',
    description: 'Alle 19 Lektionen abgeschlossen',
    hint: 'Schließe alle Lektionen ab',
    icon: '🏆',
    condition: { type: 'total-lessons', value: 19 },
    xpBonus: 50,
  },
];
